...
class Dish(models.Model):
    ...
    calories = models.FloatField(default=0, max_length=10)
    protein = models.FloatField(default=0, max_length=10)
    carbohydrates = models.FloatField(default=0, max_length=10)
    vitamins = models.FloatField(default=0, max_length=10)
